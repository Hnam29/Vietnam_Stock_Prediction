...
```
══════════════════════════════════════════════════════════════════════
                    📊  KẾT QUẢ DỰ ĐOÁN TUẦN TỚI
══════════════════════════════════════════════════════════════════════
  Mô hình hồi quy tốt nhất : RandomForestRegressor
  ──────────────────────────────────────────────────────────────────
  Giá hiện tại             :         50,000.00
  Tỷ suất sinh lời dự đoán :            +2.1500 %
  Giá dự đoán tuần tới     :         51,075.00
  Xu hướng (hồi quy)       : TĂNG ▲
  ──────────────────────────────────────────────────────────────────
  Dự đoán Logistic (3 lớp) : TĂNG ▲
  Xác suất từng xu hướng   :
    TĂNG ▲               64.30%  ██████████████████ ◀
    ĐI NGANG ↔           22.10%  ██████
    GIẢM ▼               13.60%  ███
  ──────────────────────────────────────────────────────────────────
  Đồng thuận mô hình       : ✅ XÁC NHẬN  –  Hồi quy & Logistic đồng thuận
══════════════════════════════════════════════════════════════════════
  💡 Tín hiệu được xác nhận bởi cả hai mô hình.
```
